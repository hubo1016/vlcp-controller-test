...
module.remotecall.target_url_map = {"vtepcontroller":["http://{{vtepcontroller1}}:8081",
                                                      "http://{{vtepcontroller2}}:8081"]}
...
server.startup = ('vlcp.service.sdn.viperflow.ViperFlow',
                  ...
                  'vlcp.service.sdn.vxlanvtep.VXLANVtep',
                  'vlcp.service.utils.remoteapi.RemoteCall',
