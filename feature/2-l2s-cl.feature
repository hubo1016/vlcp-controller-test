Feature: l2switch controller learning
    ...
    Scenario: l2switch logicalport on different node
        ...
        and check l2switch controller learn "be:cf:72:24:77:b0" on "host1"
        and check l2switch controller learn "76:b8:46:68:eb:ac" on "host2"
        and check l2switch controller learn "76:b8:46:68:eb:ac" on "host1"
        and check l2switch controller learn "be:cf:72:24:77:b0" on "host2"
